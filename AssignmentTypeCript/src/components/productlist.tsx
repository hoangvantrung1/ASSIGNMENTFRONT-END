    ...
    return (
        <>
            ...
            <div className="product-image">
                <img src="./image/items/item-1.png" width="500px" alt="Product Image" className="card-img" />
            ...
            <div className="product-info">
                ...
                <div className="color-options">
                    ...
                    <div className="color-icons">
                        ...
                        <label for="red" className="color-icon-red"><img src="red-icon.png" alt="Red" /></label>

                        <input type="radio" id="blue" name="color" value="blue"/>
                            <label for="blue" className="color-icon-blue"><img src="blue-icon.png" alt="Blue" /></label>

                            <input type="radio" id="black" name="color" value="black"/>
                                <label for="black" className="color-icon-black"><img src="black-icon.png" alt="Black" /></label>
                            </div>
                    </div>
                    ...
                    <button className="buy-now-button" data-id="1">BUY NOW</button>
                    <div className="delivery-frame1">
                        <div className="delivery-box">
                            <img src="image/icons/ship.jpg" width="20px" alt="Free Delivery" />
                            <h3>Free Delivery</h3>
                            <p>Get free delivery on all orders!</p>
                        </div>
                        <div className="delivery-box">
                            <img src="image/icons/return.png" width="20px" alt="Return Delivery" />
